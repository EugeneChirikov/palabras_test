...
public class DatabaseTest extends AndroidTestCase {
	...
	public void testDictionary1Add(){
		...
		testDictionary = new Dictionary("test1Dict");
...
//	}
	...
	public void testFindWord1(){
		...
		values.add(new Value("d1w2value1", "test1Dict"));
		values.add(new Value("d1w2value2", "test1Dict"));
		values.add(new Value("d1w2value3", "test1Dict"));
